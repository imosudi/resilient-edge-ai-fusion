...
from fusion.hardware_config import (
    DEFAULT_LIDAR_START_ANGLE_DEG as DEFAULT_START_ANGLE_DEG,
    DEFAULT_LIDAR_END_ANGLE_DEG as DEFAULT_END_ANGLE_DEG,
    DEFAULT_LIDAR_MIN_DISTANCE_MM as DEFAULT_MIN_DISTANCE_MM,
    DEFAULT_LIDAR_MAX_DISTANCE_MM as DEFAULT_MAX_DISTANCE_MM,
